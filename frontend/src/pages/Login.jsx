        ...
        <section className="min-h-screen flex items-center justify-center bg-[#121212] px-4">
            <div className="bg-[#1E1E1E] rounded-lg w-full max-w-md p-5 shadow-lg flex flex-col">
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-2.5">
                    ...
                    <Link
                        to="/ForgotPassword"
                        className="text-right text-sm text-[#B0B0B0] mt-1 cursor-pointer hover:text-[#FF6F61] transition-colors"
                    >
                        Forgot Password?
                    </Link>
                    ...
                    <small className="mt-4 text-center text-[#B0B0B0] border-t border-[#333] pt-3 text-sm">
                        ...
                        <Link
                            to="/signup"
                            className="text-[#FF6F61] hover:underline cursor-pointer transition-colors"
                        >
                            Sign up
                        </Link>
                    </small>
